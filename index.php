<?php
    ...
    $faq = [
        ...
        "thirdSec" => [
            ...
            "howToHeader" => "Stabilire il paese associato al tuo account",

            "howTo" => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno. <br> <br>
    ...
    <header>
        ...
        <div class="h-top">
            ...
            <div class="h-top-left">
                <img src="img/google.jpeg" alt="g-logo">
    ...
    <main>
        ...
        <div class="container">
            ...
            <?php
                ...
                // ciclo il numero delle sezioni per stampare un div per ciascuna sezione 
                foreach($faq as $section => $content){

                     
                    echo "<div class='faq'>";

                        // ciclo internamente le sezioni e stampo a seconda del tipo il contenuto
                        foreach($content as $type => $text){
                            if($type == "question"){
                                echo "<h2> $text </h2>";
                            } elseif ($type =="answer" || $type =="howTo"){
                                echo "<p> $text </p>";
                            } else {
                                echo "<h4> $text</h4>";
                            } 
